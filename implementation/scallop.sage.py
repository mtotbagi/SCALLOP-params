...
if __name__ == "__main__":
    ...
    alice = [randint(-_sage_const_3 , _sage_const_3 ) for _ in range(_sage_const_75 )]
    bob = [randint(-_sage_const_3 , _sage_const_3 ) for _ in range(_sage_const_75 )]
